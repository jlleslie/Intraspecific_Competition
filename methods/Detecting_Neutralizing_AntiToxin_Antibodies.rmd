...
1. Run a Vero cell toxin assay (see [ Vero Cell Toxin Activity Assay] (https://github.com/jlleslie/Intraspecific_Competition/blob/master/methods/Verocell_ToxinActivity_Assay.Rmd))  for protocol.
