...
3. When mice get sick, euthanize and follow the rest of the collection protocol for harvesting samples. 
...
1.	In the long-term infection model mice require a secondary antibiotic following six weeks of recovery from cefoperazone [Ref1] [Ref2]
2. To make mice susceptible again, we given them an IP of clindamycin 
	+  Open a sterile saline bottle in a BSC, remove 10nmL
