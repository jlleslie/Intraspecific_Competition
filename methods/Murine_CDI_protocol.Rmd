...
3. At the mouse facility: remove lixits (make sure there are no leaks from the socket), in a laminar flow hood pour antibiotic water into a sterile water bottle, then give the bottles to the mice
...
1. On the day of infection, dilute [spores] (Intraspecific_Competition/methods/Preparing_Cdifficile_spores.Rmd) to the desired concentration in Gbico water.  
