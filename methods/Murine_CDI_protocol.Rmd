...
3. At the mouse facility: 
	+ rRemove lixits (make sure there are no leaks from the socket) in a laminar flow hood pour antibiotic water into a sterile water bottle, then give the bottles to the mice
