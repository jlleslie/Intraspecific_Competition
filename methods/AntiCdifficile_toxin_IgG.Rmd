...
Serum from mice (2013,2014, 2015 long term infection) infected with 630 and then re-challenged with VPI will be tested for levels of anti-toxin A &  B antibodies (IgG). 
...
####Day 2: Run Assay 
1.	Wash the plate 3x with PBST (PBS + 0.05% tween) followed by 3x with PSB
2.	Block – add 100uL of 2% BSA(w/v) in PBST (blocking buffer) to each well,  Incubate for 1hr at 37C
3.	Wash the plate 3x with PBST (PBS + 0.05% tween) followed by 3x with PSB
...
1.	Antigen = 100ug of toxin A or B (lyophilized from List)
	+	10 plates coated with A or B will be needed for each assay, thus 100ug of toxin will be needed 
...
```
 ...
 Positive control = starting dilution 1/5000 of mouse anti-toxin A IgG 
...
```
1.	Wash plate 3x with PBST (PBS + 0.05% Tween) followed by 3x with PBS
