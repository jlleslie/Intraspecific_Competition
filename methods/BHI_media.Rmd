...
Autoclave using liquid setting for 25min
Note: Make sure the botte cap is very loosely screwed on.


After autoclaving and cooling in a water bath, add the following:
+ L-cysteine solution
	* 0.1g of L-cysteine/ 10mL milliQ water (Filter with 0.2um filter)
+ 1ml of 0.01% resazurin per L of BHI broth 