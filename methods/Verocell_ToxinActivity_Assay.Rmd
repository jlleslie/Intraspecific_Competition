...
3. Add appropriate  90uL of PBS to the rest of the wells on the plate
4. Serially dilute across the plate (see plate map bellow) 
<div style="text-align:center"><img src ="https://raw.githubusercontent.com/jlleslie/Intraspecific_Competition/master/images/Toxinassay_dilutionplate1.jpg?token=AJ8FttV8I_nyofPvY2ZXNHS3PrAU5R_cks5XoPgewA%3D%3D" width="500" height="300" /></div> 
...
3  Remove an aliquot of [Alere's goat anti-toxin A&B sera] (https://www.fishersci.com/shop/products/alere-c-difficile-toxin-antitoxin-kit-c-difficile-toxin-antitoxin-kit/23046761) from the -20C.
4. Dilute the sample 1:25 in sterile PBS 
5.	Alternate rows on the plate  are used for samples and anti-toxin antibodies 
	+ In rows A, C, E, and G add 20uL of PBS  across all wells
	+ In rows B, D, F, and H add 20uL of diluted anti-toxin sera 
6. 	Transfer 20uL from appropriate sample/wells on dilution plate 1 to appropriate wells on this plate 
7. Once all samples have been added incubate for 40 min so anti-toxin antibodies in sera can bind/inactivate the toxin. 
8. Add 10uL of mixture from  dilution plate 2 to appropriate Vero cell wells.
9. Incubate cells at 37C in a 5% CO2 humidified incubator
...
3.	Sample wells: Choose well that is last to have >= 80% cell rounding.
4.	Positive control: Wells with higher concentrations of toxin s diluted in PBS should be round while the counterpart wells added to the anti-toxin sera should have no rounding 
	+ This allows you to know that any cell rounding is due to the toxin and not other things in the sample 
5. 	Cell rounding is defined as:  log [final dilution factor]/ per gram of cecal content.
