...
1. Grasp mouse firmly to pick up,  collect a fresh fecal pellet into a pre-weighed sterile 1.7mL eppendorf tube 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Starting at 10^-2 -> 10^-6)
	...
	<div style="text-align:center"><img src ="https://raw.githubusercontent.com/jlleslie/Intraspecific_Competition/master/images/dilutions.jpg?token=AJ8FtsMX7KXiL_GyWrat0A2q8aBiEEEbks5XmqXzwA%3D%3D" width="300" height="200" /></div>
...
1. Write the sample name (e.g. Mouse 1) the dilution and media on each plate 
	+ TCCFA is selective and limits the growth of some of the other bacteria in feces but not all of them, if you are working with an erythromycin resistant strain (ex. 630 or R20291) you can add 2 ug/mL erythromycin to the plates to limit other bacterial growth 

###Step 6: Plate sample dilutions
1. Plate 100uL of your sample on to each plate
2. Spread the solution around the plate with L-shaped spreader
	...
	+ In the cefoperazone treated mouse model mice are generally colonized with 1E7-1E8 CFU/g feces by D1, so we plate the following dilutions: 10^-4, 10^-5, 10^-6 
3. Incubate at 37C for 18-24 hours in the anaerobic chamber, agar side of the plate up.
	+ *C. difficile* colonies on TCCFA +/- erythromycin are round, fringy, with a ground glass appearance.
